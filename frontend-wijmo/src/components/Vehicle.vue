            ...
            <v-row cols="12">
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">VehicleId</div>
                        <String label="입력하세요." v-model="value.vehicleId" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">Type</div>
                        <String label="입력하세요." v-model="value.type" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">Model</div>
                        <String label="입력하세요." v-model="value.model" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">Driver</div>
                        <String label="입력하세요." v-model="value.driver" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
                        <div class="label-title">LicensePlate</div>
                        <String label="입력하세요." v-model="value.licensePlate" :editMode="editMode"/>
                    </div>
                </v-col>
            </v-row>
        </div>
...
import VehicleBase from '../components/VehicleBase.vue'
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/vehicles";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "vehicles."+ me.value.vehicleId +".get"
