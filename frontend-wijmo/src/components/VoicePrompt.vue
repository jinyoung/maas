            ...
            <v-row cols="12">
                ...
                <v-col cols="6">
                    <div style="display:flex;">
                        ...
                        <String label="입력하세요." v-model="value.message" :editMode="editMode"/>
                    </div>
                </v-col>
                <v-col cols="6">
                    <div style="display:flex;">
...
import VoicePromptBase from '../components/VoicePromptBase.vue'
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/voicePrompts";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "voicePrompts."+ me.value.voicePromptId +".get"
    ...
    methods: {
        ...
        async save(){
            try {
                ...
                if(!this.offline) {
                    if(this.isNew) {
                        temp = await axios.post(axios.fixUrl('/voicePrompts'), this.value)
                    } else {
