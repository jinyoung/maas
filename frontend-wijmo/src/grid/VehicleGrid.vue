<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['vehicleId','type','model','driver','licensePlate',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="vehicleId" header="vehicleId" width="2*" :isReadOnly="true" align="center" />
            ...
            <wj-flex-grid-column binding="driver" header="driver" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="licensePlate" header="licensePlate" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">Vehicle 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.vehicle.href;
