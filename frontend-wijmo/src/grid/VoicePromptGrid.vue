<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['voicePromptId','reservationId','userId','message','language',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="voicePromptId" header="voicePromptId" width="2*" :isReadOnly="true" align="center" />
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">VoicePrompt 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                    <div>
                        <VoicePrompt :offline="offline"
                            :isNew="!selectedItem"
                            :editMode="true"
                            v-model="voicePromptModel"
                            @add="append"
                        />
                    </div>
                    </v-card-text>
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.voicePrompt.href;
