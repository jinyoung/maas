<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['userId','accessibleTransportation','assistanceRequired','language',]" />
            ...
            <wj-flex-grid-column binding="accessibleTransportation" header="accessibleTransportation" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="assistanceRequired" header="assistanceRequired" width="2*" :isReadOnly="true" align="center" />
            ...
            >
                ...
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">UserPreference 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                    <div>
                        <UserPreference :offline="offline"
                            :isNew="!selectedItem"
                            :editMode="true"
...
export default {
    name : 'userPreference-grid',
    mixins:[UserPreference],
    components:{
        UserPreference,
    },
    data: () => ({
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.userPreference.href;
