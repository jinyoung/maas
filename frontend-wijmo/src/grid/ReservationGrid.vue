<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['reservationId','transportationType','pickUpLocation','dropOffLocation','pickUpDateTime','dropOffDateTime','status',]" />
            ...
            <wj-flex-grid-column binding="pickUpLocation" header="pickUpLocation" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="dropOffLocation" header="dropOffLocation" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="pickUpDateTime" header="pickUpDateTime" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="dropOffDateTime" header="dropOffDateTime" width="2*" :isReadOnly="true" align="center" />
