...
pluralCaseList.push( {plural: "userPreferences", pascal: "UserPreference"} )

pluralCaseList.push( {plural: "payments", pascal: "Payment"} )

pluralCaseList.push( {plural: "vehicles", pascal: "Vehicle"} )

pluralCaseList.push( {plural: "voicePrompts", pascal: "VoicePrompt"} )

pluralCaseList.push( {plural: "accessibilityInfos", pascal: "AccessibilityInfo"} )
